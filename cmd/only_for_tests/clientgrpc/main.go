...
func main() {
	...
	var qrys = []string{
		...
		`{"action":"auth", "secret":{}, "db":"", "table":"", "fields":{}}`,
		`{"action":"read", "secret":{}, "db":"", "table":"", "fields":{}, "data":[]}`,
		`{"action":"store", "secret":{}, "db":"", "table":"", "fields":{}, "data":["Errorable Query!"]}`,
		`{"action":"auth", "secret":{}, "db":"", "table":"", "fields":{}, "data":[{}]}`,
		`{"action":"read", "secret":{}, "db":"", "table":"", "fields":{}, "data":[{},{}]}`,
		`{"action":"store", "secret":{}, "db":"", "table":"", "fields":{}, "data":[{"name":"Name"},{"name":"Name","city":"Moscow"}]}`,
		`{"action":"auth", "secret":{}, "db":"", "table":"", "fields":{}, "data":[{"name":"Name"},{"name":"Name","city":"Moscow","sub":""}]}`,
		`{"action":"read", "secret":{}, "db":"", "table":"", "fields":{}, "data":[{"name":"Name"},{"name":"Name","city":"Moscow","sub":"","age":20}]}`,
		`{"action":"store", "secret":{}, "db":"", "table":"", "fields":{"name":"Name","city":"Moscow","sub":"","age":20}, "data":[{"name":"Name"},{"name":"Name","city":"Moscow","sub":"","age":20}]}`,
		`{"action":"auth", "secret":{}, "db":"", "table":"", "fields":{"name":"Name","city":"Moscow","sub":"","age":20}, "data":[{"name":"Name"},{"name":"Name","city":"Moscow","sub":"","age":20}]}`,
		`{"action":"erread", "secret":{}, "db":"", "table":"", "fields":{"name":"Name","city":"Moscow","sub":"","age":20}, "data":[{"name":"Name"},{"name":"Name","city":"Moscow","sub":"","age":20}]}`,
	}
