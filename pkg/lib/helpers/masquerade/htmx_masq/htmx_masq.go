    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-secondary rounded h-100 p-4">
                <button type="button" class="btn btn-success"><i class="fa fa-plus-square"></i> Create a user</button><br>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Edit</button>
                                    {{ if $data.Superuser }}
                                    ...
                                    {{ else }}
                                    <button type="button" class="btn btn-sm btn-warning"><i class="fa fa-ban"></i> Block</button>
                                    <button type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash-alt"></i> Remove</button>
                                    {{ end }}
                                </div> 
                            </td>
                        </tr>
